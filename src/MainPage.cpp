...
void CGame::mainPage()
{
	...
	Iw2DDrawImage(getresource->get_facebook_button(),CIwFVec2(Iw2DGetSurfaceWidth()*0.05f,0),CIwFVec2(Iw2DGetSurfaceWidth()*0.05f,Iw2DGetSurfaceWidth()*0.05f*1.32f));
	Iw2DDrawImage(getresource->get_rate(),CIwFVec2(2.5f*(Iw2DGetSurfaceWidth()*0.05f),0),CIwFVec2(Iw2DGetSurfaceWidth()*0.05f,Iw2DGetSurfaceWidth()*0.05f*1.32f));
		...
		switch (page)
		{
			...
			case 12:
				...
				if(trans_dir == -1)
				{
					...
					Iw2DDrawImage(getresource->get_facebook_button(),CIwFVec2(trans_pos*0.05f,0),CIwFVec2(trans_pos*0.05f,Iw2DGetSurfaceWidth()*0.05f*1.32f));
					Iw2DDrawImage(getresource->get_rate(),CIwFVec2(2.5f*(trans_pos*0.05f),0),CIwFVec2(trans_pos*0.05f,Iw2DGetSurfaceWidth()*0.05f*1.32f));
					Iw2DSetColour(0xaaffffff);
					Iw2DDrawImageRegion(getresource->get_menu_button(),CIwFVec2(trans_pos*0.80f-(trans_pos*0.253f)/2,Iw2DGetSurfaceHeight()*0.25f-menu_button_size.y/2),CIwFVec2(trans_pos*0.253f,menu_button_size.y),CIwFVec2(0,0),CIwFVec2(325,96));
					Iw2DDrawImageRegion(getresource->get_menu_button(),CIwFVec2(trans_pos*0.80f-(trans_pos*0.253f)/2,Iw2DGetSurfaceHeight()*0.50f-menu_button_size.y/2),CIwFVec2(trans_pos*0.253f,menu_button_size.y),CIwFVec2(325,0),CIwFVec2(325,96));
					Iw2DDrawImageRegion(getresource->get_menu_button(),CIwFVec2(trans_pos*0.80f-(trans_pos*0.253f)/2,Iw2DGetSurfaceHeight()*0.75f-menu_button_size.y/2),CIwFVec2(trans_pos*0.253f,menu_button_size.y),CIwFVec2(0,96),CIwFVec2(325,96));
					Iw2DSetColour(0xffffffff);
				}
			...
			case 1124:
				...
				if(trans_dir == -1)
				{
					...
					if(resume_classic == 1)
					{
						Iw2DDrawImageRegion(getresource->get_menu_button(),CIwFVec2(trans_pos*0.80f-(trans_pos*0.253f)/2,Iw2DGetSurfaceHeight()*1/5-menu_button_size.y/2),CIwFVec2(trans_pos*0.253f,menu_button_size.y),CIwFVec2(325,384),CIwFVec2(325,96));
						Iw2DDrawImageRegion(getresource->get_menu_button(),CIwFVec2(trans_pos*0.80f-(trans_pos*0.253f)/2,Iw2DGetSurfaceHeight()*2/5-menu_button_size.y/2),CIwFVec2(trans_pos*0.253f,menu_button_size.y),CIwFVec2(325,192),CIwFVec2(325,96));
						Iw2DDrawImageRegion(getresource->get_menu_button(),CIwFVec2(trans_pos*0.80f-(trans_pos*0.253f)/2,Iw2DGetSurfaceHeight()*3/5-menu_button_size.y/2),CIwFVec2(trans_pos*0.253f,menu_button_size.y),CIwFVec2(0,288),CIwFVec2(325,96));
						Iw2DDrawImageRegion(getresource->get_menu_button(),CIwFVec2(trans_pos*0.80f-(trans_pos*0.253f)/2,Iw2DGetSurfaceHeight()*4/5-menu_button_size.y/2),CIwFVec2(trans_pos*0.253f,menu_button_size.y),CIwFVec2(325,288),CIwFVec2(325,96));
					}
					else
					{
						Iw2DDrawImageRegion(getresource->get_menu_button(),CIwFVec2(trans_pos*0.80f-(trans_pos*0.253f)/2,Iw2DGetSurfaceHeight()*0.25f-menu_button_size.y/2),CIwFVec2(trans_pos*0.253f,menu_button_size.y),CIwFVec2(325,192),CIwFVec2(325,96));
						Iw2DDrawImageRegion(getresource->get_menu_button(),CIwFVec2(trans_pos*0.80f-(trans_pos*0.253f)/2,Iw2DGetSurfaceHeight()*0.50f-menu_button_size.y/2),CIwFVec2(trans_pos*0.253f,menu_button_size.y),CIwFVec2(0,288),CIwFVec2(325,96));
						Iw2DDrawImageRegion(getresource->get_menu_button(),CIwFVec2(trans_pos*0.80f-(trans_pos*0.253f)/2,Iw2DGetSurfaceHeight()*0.75f-menu_button_size.y/2),CIwFVec2(trans_pos*0.253f,menu_button_size.y),CIwFVec2(325,288),CIwFVec2(325,96));
					}
					Iw2DSetColour(0xffffffff);
				}
				/*if(trans_dir == -1)
