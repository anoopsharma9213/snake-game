...
void CGame::play_Page_Update()
{
	...
	_store->l_cl = level_cl;
				_store->ca_block = block;
				_store->ca_f_dir = f_dir;
				_store->ca_move = move;
				_store->ca_f_pos = f_Position;
				for(int i=0;i<100;i++)
				{
					_store->ca_block_dir[i] = 0;
				}
				for (var = 0, b_dir = START; var < block; var++,b_dir = b_dir->next)
				{
					_store->ca_block_dir[var] = b_dir->dir;
				}
...
void CGame::play_Page()
{
	...
	Iw2DDrawImage(getresource->get_bg(maze_count),CIwFVec2(0,0),CIwFVec2((float)Iw2DGetSurfaceWidth(),(float)Iw2DGetSurfaceHeight()));
	...
	for (int i = 0; i < wall_max; i++)
	{
		...
		{
		case 1:
			Iw2DDrawImageRegion(getresource->get_wall(),CIwFVec2(beg.x+b_size.x+w_position[i].x*g_size.x,beg.y+b_size.x+w_position[i].y*g_size.y),g_size,CIwFVec2(0,0),CIwFVec2(30,30));
			break;
		case 2:
			Iw2DDrawImageRegion(getresource->get_wall(),CIwFVec2(beg.x+b_size.x+w_position[i].x*g_size.x,beg.y+b_size.x+w_position[i].y*g_size.y),g_size,CIwFVec2(30,0),CIwFVec2(30,30));
			break;
		case 3:
			Iw2DDrawImageRegion(getresource->get_wall(),CIwFVec2(beg.x+b_size.x+w_position[i].x*g_size.x,beg.y+b_size.x+w_position[i].y*g_size.y),g_size,CIwFVec2(30,0),CIwFVec2(30,30));
			break;
		case 4:
			Iw2DDrawImageRegion(getresource->get_wall(),CIwFVec2(beg.x+b_size.x+w_position[i].x*g_size.x,beg.y+b_size.x+w_position[i].y*g_size.y),g_size,CIwFVec2(60,0),CIwFVec2(30,30));
			break;
		case 5:
			Iw2DDrawImageRegion(getresource->get_wall(),CIwFVec2(beg.x+b_size.x+w_position[i].x*g_size.x,beg.y+b_size.x+w_position[i].y*g_size.y),g_size,CIwFVec2(90,0),CIwFVec2(30,30));
			break;
		case 6:
			Iw2DDrawImageRegion(getresource->get_wall(),CIwFVec2(beg.x+b_size.x+w_position[i].x*g_size.x,beg.y+b_size.x+w_position[i].y*g_size.y),g_size,CIwFVec2(60,0),CIwFVec2(30,30));
			break;
		case 7:
			Iw2DDrawImageRegion(getresource->get_wall(),CIwFVec2(beg.x+b_size.x+w_position[i].x*g_size.x,beg.y+b_size.x+w_position[i].y*g_size.y),g_size,CIwFVec2(150,0),CIwFVec2(30,30));
			break;
		case 8:
			Iw2DDrawImageRegion(getresource->get_wall(),CIwFVec2(beg.x+b_size.x+w_position[i].x*g_size.x,beg.y+b_size.x+w_position[i].y*g_size.y),g_size,CIwFVec2(60,0),CIwFVec2(30,30));
			break;
	...
	case 0:
		...
		break;
	case 1:
		Iw2DDrawImageRegion(getresource->get_food(),CIwFVec2(beg.x+b_size.x+f_Position.x*g_size.x,beg.y+b_size.x+f_Position.y*g_size.y),f_Size,CIwFVec2(30,0),CIwFVec2(30,30));
		break;
	case 2:
		Iw2DDrawImageRegion(getresource->get_food(),CIwFVec2(beg.x+b_size.x+f_Position.x*g_size.x,beg.y+b_size.x+f_Position.y*g_size.y),f_Size,CIwFVec2(0,0),CIwFVec2(30,30));
		break;
	case 3:
		Iw2DDrawImageRegion(getresource->get_food(),CIwFVec2(beg.x+b_size.x+f_Position.x*g_size.x,beg.y+b_size.x+f_Position.y*g_size.y),f_Size,CIwFVec2(60,0),CIwFVec2(30,30));
		break;
	case 4:
		Iw2DDrawImageRegion(getresource->get_food(),CIwFVec2(beg.x+b_size.x+f_Position.x*g_size.x,beg.y+b_size.x+f_Position.y*g_size.y),f_Size,CIwFVec2(90,0),CIwFVec2(30,30));
		break;
	case 5:
		Iw2DDrawImageRegion(getresource->get_food(),CIwFVec2(beg.x+b_size.x+f_Position.x*g_size.x,beg.y+b_size.x+f_Position.y*g_size.y),f_Size,CIwFVec2(90,0),CIwFVec2(30,30));
		break;
	case 6:
		Iw2DDrawImageRegion(getresource->get_food(),CIwFVec2(beg.x+b_size.x+f_Position.x*g_size.x,beg.y+b_size.x+f_Position.y*g_size.y),f_Size,CIwFVec2(120,0),CIwFVec2(30,30));
		break;
	case 7:
		Iw2DDrawImageRegion(getresource->get_food(),CIwFVec2(beg.x+b_size.x+f_Position.x*g_size.x,beg.y+b_size.x+f_Position.y*g_size.y),f_Size,CIwFVec2(90,0),CIwFVec2(30,30));
		break;
	...
	case 4:
	case 5:
		Iw2DDrawImageRegion(getresource->get_tail(),a_move,g_size,CIwFVec2(30,0),CIwFVec2(30,30));
		break;
	case 6:
	case 7:
	case 8:
		Iw2DDrawImageRegion(getresource->get_tail(),a_move,g_size,CIwFVec2(60,0),CIwFVec2(30,30));
		break;
	}
	Iw2DSetTransformMatrix(CIwFMat2D::g_Identity);
	...
	for(var=1, b_dir = START; var<block; var++,b_dir=b_dir->next)
	{
		...
		if(var==block-1)
		{
			...
			case 1:
				...
				case 4:
				case 5:
					Iw2DDrawImageRegion(getresource->get_head(),a_move,g_size,CIwFVec2(30,0),CIwFVec2(30,30));
					break;
				case 6:
				case 7:
				case 8:
					Iw2DDrawImageRegion(getresource->get_head(),a_move,g_size,CIwFVec2(60,0),CIwFVec2(30,30));
					break;
				}
				...
				case 4:
				case 5:
					Iw2DDrawImageRegion(getresource->get_tongue(),a_move,g_size,CIwFVec2(30,0),CIwFVec2(30,30));
					break;
				}
				Iw2DSetTransformMatrix(CIwFMat2D::g_Identity);
				a_move.x = a_move.x-g_size.x;
		...
		else if (b_dir->dir != b_dir->next->dir && maze_count < 6)
		{
			if(b_dir->dir == 1)
			{
				if (b_dir->next->dir == -2)
			...
			case 4:
			case 5:
				Iw2DDrawImageRegion(getresource->get_turn(),a_move,g_size,CIwFVec2(30,0),CIwFVec2(30,30));
				break;
			}
			Iw2DSetTransformMatrix(CIwFMat2D::g_Identity);
		}
		else
		{
			...
			case 4:
			case 5:
				Iw2DDrawImageRegion(getresource->get_body(),a_move,g_size,CIwFVec2(30,0),CIwFVec2(30,30));
				break;
			case 6:
			case 7:
			case 8:
